...
from examples.sovereign_agent.agent import AgentPolicy, SovereignAgent
from examples.sovereign_agent.agent_composition import AgentCompositionEngine
from examples.sovereign_agent.agent_disagreement import AgentDisagreementEngine
from examples.sovereign_agent.authority_races import AuthorityRaceEngine
...
from examples.sovereign_agent.multi_agent_environment import build_multi_agent_environment
...
def run_intent_graph_trial() -> IntentGraphResult:
    ...
    if p1 and p2:
        from examples.sovereign_agent.agent_composition import CompositionType
    ...
    from examples.sovereign_agent.authority_races import build_race_scenarios
