...
from research.examples.sovereign_agent.environment import PaymentInfrastructureEnvironment
from research.examples.sovereign_agent.interfaces import (
    CombinedSovereignInterface,
    ResponseType,
)
from research.examples.sovereign_agent.trial_environment import TrialEnvironment, WorldState
...
def run_confidently_wrong_suite() -> dict[str, AgentResult]:
    ...
    from research.examples.sovereign_agent.trial_environment import TrialEnvironment
